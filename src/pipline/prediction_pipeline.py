...
class VehicleDataClassifier:
    ...
    def predict(self, dataframe) -> str:
        ...
        try:
            ...
            # ensure that no identifier column is passed to the transformer.
            # the preprocessing object was retrained without `id`, so we drop
            # it if present rather than attempting to manufacture one.
            if 'id' in dataframe.columns:
                logging.info("Dropping 'id' column from input dataframe before prediction")
